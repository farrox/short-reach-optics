...
% Experience-driven judgment boxes (Technical Authority Pass). Distinct from
% \engcheck (procedure) and \keyidea (chapter takeaway).
\definecolor{heuristicbg}{HTML}{F0EDE6}
\definecolor{heuristicrule}{HTML}{6B5E4E}
\newcommand{\heuristic}[1]{%
  \endgraf\medskip\noindent
  \fcolorbox{heuristicrule}{heuristicbg}{%
    \begin{minipage}{\dimexpr\textwidth-2\fboxsep-2\fboxrule\relax}
      \textbf{Engineering heuristic.~}#1
    \end{minipage}%
  }%
  \endgraf\medskip
}
\newcommand{\whyexp}[2]{%
  ...
  \fcolorbox{heuristicrule}{heuristicbg}{%
    \begin{minipage}{\dimexpr\textwidth-2\fboxsep-2\fboxrule\relax}
      \textbf{Why experienced engineers #1}\par\smallskip
      #2
    \end{minipage}%
  }%
  \endgraf\medskip
}
\newcommand{\usuallymeans}[3]{%
  \endgraf\medskip\noindent
  \fcolorbox{heuristicrule}{heuristicbg}{%
    \begin{minipage}{\dimexpr\textwidth-2\fboxsep-2\fboxrule\relax}
      \textbf{What this usually means.~}#1\par\smallskip
      \textit{Usually:} #2\par\smallskip
      \textit{Not:} #3
    \end{minipage}%
  }%
  \endgraf\medskip
...
% Staff-level constraint boxes (Tradeoff Engineering Pass). Distinct from
% heuristics (priors) and engcheck (procedure).
\definecolor{tradeoffbg}{HTML}{EDE8F0}
\definecolor{tradeoffrule}{HTML}{5A4E6B}
\newcommand{\tradeoff}[5]{%
  \endgraf\medskip\noindent
  \fcolorbox{tradeoffrule}{tradeoffbg}{%
    \begin{minipage}{\dimexpr\textwidth-2\fboxsep-2\fboxrule\relax}
      \textbf{Tradeoff.~}#1\par\smallskip
      \textit{Improves:} #2\par\smallskip
      \textit{Worsens:} #3\par\smallskip
      \textit{When acceptable:} #4\par\smallskip
      \textit{Experienced decision:} #5
    \end{minipage}%
  }%
  \endgraf\medskip
}
\newcommand{\decisionex}[4]{%
  \endgraf\medskip\noindent
  \fcolorbox{tradeoffrule}{tradeoffbg}{%
    \begin{minipage}{\dimexpr\textwidth-2\fboxsep-2\fboxrule\relax}
      \textbf{Decision example.~}#1\par\smallskip
      \textit{Evidence:} #2\par\smallskip
      \textit{Decision:} #3\par\smallskip
      \textit{Why:} #4
    \end{minipage}%
  }%
  \endgraf\medskip
...
\newcommand{\fwfirst}[1]{%
  \paragraph{First thing I would check.}
  #1\par
}
\newcommand{\fwwhy}[1]{%
