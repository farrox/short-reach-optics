...
% ASCII decision trees (interview appendices). Keep trees narrow for the
% text column; use flexible columns so long lines wrap rather than overflow.
...
\newcommand{\fwwhy}[1]{%
  \paragraph{Engineering reasoning.}
  #1\par
}
\newcommand{\fwmeas}[1]{%
