...
\keyidea{Measure LIV, SMSR, and RIN on every laser path; write the requirements
slice in \Cref{sec:laser-reqs} before DVT; budget bias-driver noise against the
same RIN floor (\Cref{sec:laser-drivers}); project aging with Arrhenius and derate
in the field; prefer ELSFP/CW-WDM when fleet FIT and hot-swap matter. At gigawatt
scale the laser is still the part most likely to bring a link down.}
