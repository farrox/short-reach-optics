...
\heuristic{A power rise after a firmware update is often deeper equalization,
retries, or thermal control, not a new laser physics. Check what the software
asked the hardware to do.}

Junior mistake: quote faceplate watts without a measured energy-per-bit split, or
treat peak FLOPs as proof the fabric is not the limit
(\Cref{ch:networking,sec:collectives}).

\section{Interview takeaway}
\label{sec:firstprinciples-design-review}
