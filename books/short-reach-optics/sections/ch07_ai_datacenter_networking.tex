...
\tradeoff{More telemetry vs operational complexity}{Faster isolation of weak
rails and lot-scoped escapes}{Storage, firmware, and false-alarm load}{When each
field maps to a triage decision and an owner}{Instrument ledgers that unlock
contain or repair; skip vanity counters (\Cref{fw:telemetry}).}
