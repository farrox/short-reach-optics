...
Phase-label guidance and \Cref{tab:phase-readiness-map} live in
\Cref{ch:productization,sec:phase-labels}.
...
The step-by-step readiness narrative lives in
\Cref{ch:productization,sec:readiness-steps}.
