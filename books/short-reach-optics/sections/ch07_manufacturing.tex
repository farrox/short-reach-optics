...
\item Establish SPC and reaction plans.
...
ATP decides whether an individual unit meets acceptance criteria. SPC monitors
selected process or product metrics in build order to detect movement before it
becomes an escape or yield cliff. A useful SPC metric has a trustworthy
measurement, sensitivity to a real process input, an owner, a trigger, an
immediate containment window, an investigation path, and restart criteria. A
control chart without a reaction plan is just a visualization.
