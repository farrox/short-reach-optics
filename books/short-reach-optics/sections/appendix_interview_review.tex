...
\textit{Learn:} IM/DD, WDM, AI networking
(\Cref{ch:imdd,ch:wdm,ch:networking,ch:role}); fleet trees and cases
...
\textit{Learn:} three cheat sheets below; Top~25 index (\Cref{app:top25});
thirty-second callouts (\Cref{app:interview-frameworks}); whiteboard trees
(\Cref{app:decision-trees}).\\
...
Compress: Day~1, Day~3 validation, Day~4 reliability, Day~5 manufacturing,
Day~7 mock. Keep the cheat sheets and Top~25. Cut new chapter reading first.
