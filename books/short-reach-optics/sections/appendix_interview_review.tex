...
Do not invent a second framework. Use this loop inside the validation lifecycle
(\Cref{tab:ladder}), the qualification evidence path
...
in \Cref{sec:validation-workflow}.

Night-before path: validation playbook in \Cref{fw:validation-plan}.
