...
\item[DFE (decision-feedback equalizer)] \firstterm{DFE} cancels post-cursor ISI
      ...
      at the slicer (\Cref{sec:eye-budget}). DFE creates feedback-loop timing
      complexity and error propagation; system latency depends on implementation and
      any additional block processing or retiming. It recovers more ISI than FFE
      alone at high loss.
