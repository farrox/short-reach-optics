...
\emph{pre-FEC}\firstterm{pre-FEC} BER threshold, on the order of $2.4\times10^{-4}$, which FEC then
drives down to an effectively error-free \emph{post-FEC}\firstterm{post-FEC} BER.
