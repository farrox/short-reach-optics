...
\begin{enumerate}
\item Why is a temperature sweep not the same as temperature qualification?
\item What makes an accelerated stress relevant rather than merely severe?
\item Why do zero failures in a small sample not prove a negligible
      field-failure rate?
\end{enumerate}
