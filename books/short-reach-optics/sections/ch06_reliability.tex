...
\item[System validation] Demonstrates that the complete product is suitable for
      its intended system use (\Cref{ch:product-readiness}).
\item[Reliability qualification] Builds confidence that named lifetime and
      environmental mechanisms do not violate the intended claim. This is
      Step~6 of the product-readiness lifecycle in \Cref{ch:product-readiness}.
...
temperature. Verification checks that ship power and BER meet the PRD. System
...
how much margin remains after the expected stresses. Reliability qualification
is Step~6 of the product-readiness lifecycle described in
\Cref{ch:product-readiness,sec:product-readiness}; manufacturing validation and
ATP live in \Cref{ch:manufacturing}. Keep the customer view and the vendor view
distinct: the
