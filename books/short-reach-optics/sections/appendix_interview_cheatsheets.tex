...
Bisection $\rightarrow$ Oversubscription at named tier $\rightarrow$ Rails
$\rightarrow$ Rack port and optics count $\rightarrow$ Copper vs optics
...
\item Rails buy isolation and cost more optics.
\item Scale-up and scale-out are different planes.
\item A rack sketch must count ports, modules, and replaceables.
\end{itemize}
...
\footnotesize Depth: \Cref{ch:hpc,sec:topologies,sec:collectives,sec:scale-up-out}.
