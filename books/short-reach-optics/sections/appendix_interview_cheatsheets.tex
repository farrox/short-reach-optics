...
9 & How does a sound design become a controlled product? \\
10 & How do I find and prevent the real cause of a failure? \\
\bottomrule
\end{tabular}
\end{center}

\paragraph{How to use these sheets.}
Spend about 2--3 minutes per page. Prefer the PAM4 versus PAM8 and FFE versus
DFE sheets, then models through WDM, productization, and failure analysis. The
productization flashcards at the end are a secondary reference bank, not the
primary study set. Full depth:
\Cref{ch:multilevel,ch:equalization,ch:models,ch:lasers,ch:wdm,ch:productization,ch:failure-modes}.
...
\clearpage
\section{Chapter 9: Productization and fleet readiness}
...
\clearpage
\section{Chapter 10: Failure analysis}
