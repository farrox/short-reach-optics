...
5 & What sets BER and margin? \\
6 & How do the source and modulator behave? \\
7 & How do wavelength and WDM stay controlled? \\
8 & How does a sound design become a controlled product? \\
9 & How do I find and prevent the real cause of a failure? \\
\bottomrule
\end{tabular}
\end{center}

\paragraph{How to use these sheets.}
Spend about 2--3 minutes per page. Prefer the PAM4 versus PAM8 sheet,
Chapters~5--7, productization, and failure analysis. The productization
flashcards at the end are a secondary reference bank, not the primary study
set. Full depth:
\Cref{ch:multilevel,ch:models,ch:lasers,ch:wdm,ch:productization,ch:failure-modes}.
...
\clearpage
\section{Chapter 5: Quantitative link behavior}
\label{sec:cheat-ch4}
...
\clearpage
\section{Chapter 6: Sources and modulation}
\label{sec:cheat-ch5}
...
\clearpage
\section{Chapter 7: WDM and wavelength control}
\label{sec:cheat-ch6}
...
\clearpage
\section{Productization and fleet readiness}
...
\clearpage
\section{Chapter 9: Failure analysis}
