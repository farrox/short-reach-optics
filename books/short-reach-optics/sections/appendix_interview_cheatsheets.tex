...
7 & How does a sound design become a controlled product? \\
8 & How do I find and prevent the real cause of a failure? \\
\bottomrule
\end{tabular}
\end{center}

\paragraph{How to use these sheets.}
Spend about 2--3 minutes per page. Prefer Chapters~4--6, the productization
sheet, and failure analysis. The productization flashcards at the end are a
secondary reference bank, not the primary study set. Full depth:
\Cref{ch:models,ch:lasers,ch:wdm,ch:productization,ch:failure-modes}.
...
\clearpage
\section{Chapter 8: Failure analysis}
