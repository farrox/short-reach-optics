...
The vendor designs the internals. The customer characterizes the behavior and
owns the deployment decision. An optical eye is measured externally with
suitable access; do not assume the module reports a conventional eye
...
different actions. The system owner keeps responsibility for evidence quality
and verifying corrective action (\Cref{sec:tree-escape,sec:tree-recurrence}).
Organize the spent margin with the five ledgers before naming a component
