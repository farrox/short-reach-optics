...
\tradeoff{More qualification stress vs schedule}{Mechanism coverage and life
confidence}{Calendar delay and engineering bandwidth}{When the open risk is a
named mechanism without a production proxy}{Buy the next stress that removes the
largest remaining uncertainty, then stop.}
...
\tradeoff{Best laboratory performance vs production yield}{Peak component
metrics on engineering lots}{Lower yield, harder calibration, and field
escapes}{When a slightly softer design still meets system requirements with
process control}{Optimize the manufacturable system, not the hero sample.}
