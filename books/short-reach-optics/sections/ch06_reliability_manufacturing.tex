...
stress intent. Qualification owns environmental and reliability evidence.
PVT is production readiness. Controlled pilot is bounded field confirmation.
MP is sustained production with fleet feedback. Do not use an EVT hero sample
as PVT evidence, and do not treat MP as ``fleet monitoring'' alone
(\Cref{sec:ladder-fleet,sec:ladder-fleet-monitor}).
