...
modules and discrete lasers. Map evidence with
\Cref{sec:tree-qual-evidence}:
...
(\Cref{sec:tree-qual-evidence}; interview form \Cref{fw:qual-plan}).\par}
\end{table*}
...
What confidence is required?
  |
What production control prevents escape?
\end{dectree}
...
\item \textbf{8D / CAPA}\firstterm{eightD}: root cause with the supplier (process step,
      ...
      SPC limit, poke-yoke).
\item \textbf{Verify closure:} containment proved effective; root cause reproduced
