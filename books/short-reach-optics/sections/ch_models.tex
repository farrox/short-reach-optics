...
\begin{itemize}
\item \textbf{PIN (Ge-on-Si):} no internal gain; lowest excess noise; mainstream
...
\item \textbf{UTC/MUTC:} electron-only transport for $>\!200$~GHz BW and high
...
raw sensitivity~\cite{utc}. SOA-preamplified receivers bolt optical gain ahead of
...
$P_{\text{sens}}=Q\,i_n/\mathcal{R}$. With these (and a few dozen lines of
Python) you can predict, budget, and debug a link before touching a bench.}
