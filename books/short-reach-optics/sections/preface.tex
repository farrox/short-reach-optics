...
\item[Deep learning] Read the body chapters from requirements downward
      ...
      \Cref{ch:equalization}, and packaging in \Cref{ch:packaging}), then the
      failure-analysis method (\Cref{ch:failure-modes}). Every major chapter
      asks: How does it work? How is it measured, and what uncertainty does the
      measurement remove? How does it fail? How is it debugged?
