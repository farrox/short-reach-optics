...
\item[Incident / problem solving] Open the wall-chart trees
      (\Cref{app:decision-trees}), the failure handbook
      (\Cref{ch:failure-modes}), a matching case
      (\Cref{app:case-studies}), and the Staff judgment appendix
      (\Cref{app:staff-thinking}). Recover the method in minutes, not hours.
\end{description}
...
Content freeze: this handbook is frozen for expansion. Prefer cuts, cross-refs,
and errata over new frameworks or chapters.
