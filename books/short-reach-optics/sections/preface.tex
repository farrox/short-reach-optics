...
\item[Interview preparation] Follow the one-week plan
      ...
      (\Cref{app:case-studies}), drill thirty-second answers
      (\Cref{app:interview-frameworks}), and review the Top~25 question index
      (\Cref{app:top25}).
\item[Incident / problem solving] Open the wall-chart trees
      (\Cref{app:decision-trees}), the failure handbook
      (\Cref{ch:failure-modes}), and a matching case
      (\Cref{app:case-studies}). Recover the method in minutes, not hours.
\end{description}
