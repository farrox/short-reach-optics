...
fundamentals: why inference-scale computing puts the interconnect on the
critical path (\Cref{ch:role}), and how AI datacenter networks are built where
optics dominate cost and power (\Cref{ch:networking}).
