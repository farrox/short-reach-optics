...
supplier first-article packages. The compact factory spine lives in
\Cref{ch:productization,ch:manufacturing}. The relocated full manufacturing
narrative follows after the lookup material below.
...
\section{Relocated manufacturing narrative}
\label{sec:relocated-manufacturing-narrative}

The following sections are the former manufacturing-validation chapter body,
kept as reference depth. Start from \Cref{ch:productization} for the interview
spine. Extended drills remain in
\Cref{sec:manufacturing-interview-qa,sec:cheat-flashcards}.

\input{sections/body_manufacturing}
