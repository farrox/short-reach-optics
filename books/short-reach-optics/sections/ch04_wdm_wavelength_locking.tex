...
bandwidth per strand}{Heaters, TEC, lock firmware, thermal crosstalk, and ATP
unlock corners}{When fiber plant or connector count is the binding constraint}{Pay
for locking only when multiplexing is worth the control burden.}
...
\heuristic{One-lane unlock with healthy neighbors usually points at that lane's
laser, ring, heater, or attach. All-lane unlock points at a shared resource
first.}
