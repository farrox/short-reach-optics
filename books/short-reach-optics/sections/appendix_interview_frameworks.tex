...
thirty-second close. Memorize the callouts labeled ``30-second answer.''
Expand only where the interview asks. Use \Cref{sec:tree-evidence-block}
when stating claim, population, plane, access, and decision.
