...
<table class="book-table"><tr><th>Ch</th><th>Main question</th></tr><tr><td>4</td><td>PAM4 versus PAM8: baud relief versus vertical cost?</td></tr><tr><td>5</td><td>What sets BER and margin?</td></tr><tr><td>6</td><td>How do the source and modulator behave?</td></tr><tr><td>7</td><td>How do wavelength and WDM stay controlled?</td></tr><tr><td>8</td><td>How does a sound design become a controlled product?</td></tr><tr><td>9</td><td>How do I find and prevent the real cause of a failure?</td></tr></table>
##### How to use these sheets.

Spend about 2--3 minutes per page. Prefer the PAM4 versus PAM8 sheet, Chapters 5--7, productization, and failure analysis. The productization flashcards at the end are a secondary reference bank, not the primary study set. Full depth: Chapter 4, Chapter 5, Chapter 6, Chapter 7, Chapter 8, Chapter 9.
...
Depth: Chapter 4, §5.6, §3.9.

## Chapter 5: Quantitative link behavior
...
## Chapter 6: Sources and modulation
...
## Chapter 7: WDM and wavelength control
...
## Productization and fleet readiness
...
Depth: Chapter 8, Table 8.2, Appendix F, Appendix G.
...
Secondary reference only. The primary productization interview set is the eight questions in §8.14. Use these cards if you need extra one-breath drills after the architecture chapters. Depth: Chapter 8, Chapter 9, Appendix F, Appendix G.
...
<div class="nav-links">
  <a href="ch21-abbreviations-and-terminology">&larr; Previous</a>
  <a href="./">Table of Contents</a>
  <a href="ch23-references">Next &rarr;</a>
</div>
