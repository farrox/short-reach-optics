...
*Spoken answer.* "EQ reduces ISI; FEC cleans residual errors. Aggressive EQ that boosts noise can increase FEC demand. I treat them as one budget: open the eye without driving corrected-error rate into a corner" (Chapter 6, Chapter 9).
