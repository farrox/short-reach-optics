...
<table class="book-table"><tr><th>Do not confuse</th><th>With</th></tr><tr><td>Bisection bandwidth</td><td>Sum of all link speeds</td></tr><tr><td>Mean link utilization</td><td>Collective peak demand</td></tr><tr><td>Scale-up</td><td>Scale-out</td></tr><tr><td>Fat-tree name</td><td>Closed optics and power budget</td></tr></table>
##### Trap.

Trap: "Pick fat tree and the biggest switch."\
Better: "Name collective, bisection, rails, then port and optics counts."

##### 60-second answer.

"I start from the collective and failure domain. I split scale-up from scale-out, size bisection and oversubscription at each tier, choose rail count, sketch the rack with ports and optics, pick copper versus optics by reach, and I state power and serviceability. Topology names come after those numbers."
...
Depth: Chapter 11, Table 11.2, Appendix F, Appendix G.
...
Secondary reference only. The primary productization interview set is the eight questions in §11.14. Use these cards if you need extra one-breath drills after the architecture chapters. Depth: Chapter 11, Chapter 12, Appendix F, Appendix G.
...
<div class="nav-links">
  <a href="ch24-abbreviations-and-terminology">&larr; Previous</a>
  <a href="./">Table of Contents</a>
  <a href="ch26-references">Next &rarr;</a>
</div>
