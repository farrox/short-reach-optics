...
Appendix C.4, Appendix D.4, §7.1.5: scope; power versus quality; measure remaining margin at the failing temperature first.
...
Appendix C.4, §7.1.5, Appendix A.10.3, §10.13.
