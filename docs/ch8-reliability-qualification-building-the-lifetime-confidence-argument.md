...
**Table 8.2.** Mechanism families and the evidence each one needs. Plan coverage against this table before choosing stresses. Named methods: Table F.2. Filled planning cells including production control: Table F.3. Field classification of an observed failure: §11.10.
