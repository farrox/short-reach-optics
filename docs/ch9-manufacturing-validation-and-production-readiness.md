...
**Table 9.1.** Adjacent activities. Do not use qualification, manufacturing validation, ATP, SPC, and fleet monitoring interchangeably. Manufacturing validation is Step 7 of the product-readiness lifecycle in §7.3.
...
New product introduction (*NPI*) is the cross-functional program that moves a design into controlled production. It is an organizational umbrella for engineering evidence, supplier readiness, factory process development, test development, quality planning, operations, change control, and ramp, not a technical evidence category beside the product-readiness lifecycle in §7.3. Write exit criteria a supplier can fail without ambiguity, not slogans. EVT/DVT/PVT/MP are program-phase labels, not a calendar; dates and sample sizes belong in the program plan (§7.1).
