...
**Deep dive.** Power fork and instruments: Appendix A.8.3. APC and calibration: §7.11.
...
**Deep dive.** Worked answer: Appendix A.10.6. FAU and parallel optics appear throughout Chapter 12.
...
**Deep dive.** Appendix A.10.4, §7.11, §7.10.
...
**Key concepts.** Component and complete-product second sources have different access, interop burden, and owners (Appendix D.8, Appendix G.16, Appendix D.16).
...
**Deep dive.** Appendix A.10.5, Appendix G.16.
...
**Deep dive.** Appendix A.10.2, Table 11.2, Appendix A.8.7.
...
**Key concepts.** Fleet economics and scope pick the owner before FA. Pulling units without a bucket wastes the only failing state you had (Appendix A.6, §12.10).
...
**Deep dive.** Appendix A.10.8, Appendix I.2.1, §6.3.
...
**Key concepts.** Intermittents die when the evidence is destroyed. NFF is often a triage failure, not a healthy part (§12.10).
...
Add a register only if it changes contain, derate, RMA, or FA ownership. Full tradeoff: §12.10.
...
**Deep dive.** Appendix A.8.5, Appendix F.1.1, §7.13.
...
*Criteria:* allocate margin where uncertainty is highest; do not maximize every ledger (§7.19, Chapter 11).
...
*Criteria:* each field needs a decision owner and a reaction plan (Appendix C.14, §12.10).

##### Would you run more qualification?

*Benefit:* confidence and fewer late escapes.\
*Downside:* schedule, cost, delayed learning.\
*Criteria:* prioritize by risk $\times$ uncertainty $\times$ impact; stop when remaining risk has a production control (Appendix F.10).
...
*Criteria:* qualify on concentration risk and evidence, not ideology (Appendix G.16, Appendix C.7).

##### Would you increase ATP coverage?

*Benefit:* escape detection earlier in the flow.\
*Downside:* cycle time, cost, false rejects.\
*Criteria:* cheapest control that reliably detects the named mechanism: 100%, sample, SPC, or supplier process (Appendix G.14).
...
<div class="nav-links">
  <a href="ch14-engineering-case-studies">&larr; Previous</a>
  <a href="./">Table of Contents</a>
  <a href="ch16-engineering-decision-trees">Next &rarr;</a>
</div>
