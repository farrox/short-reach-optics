...
One unit is a story. A lot, rack, vendor, or time trend is a decision. Scope before you generalize (§11.16, Appendix C.9). Telemetry earns its keep only when each field has a decision owner and a reaction plan (Appendix C.14).
