...
Treat supplier conversations like debug with a second party across the table (Appendix B.4, §9.9, Appendix C.10). Scope first: lot, site, date code, plane, condition. Ask for evidence that would change your ship call. Offer the measurements you will accept as closure.
