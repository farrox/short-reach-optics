...
*Answer pivot.* "Enough for which claim? If the 200 are balanced across the intended sources of variation, they may characterize central distributions, early yield, and station behavior. But even with zero observed defects, the approximate one-sided 95% upper bound is about $3/200$, or 1.5%, under an independent Bernoulli model. That is nowhere near evidence for a low-DPPM escape claim. I would state the precision, population coverage, and release decision those units actually support."
