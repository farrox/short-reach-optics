...
## Chapter 9: Productization and fleet readiness
...
Depth: Chapter 9, Table 9.2, Appendix F, Appendix G.
...
Secondary reference only. The primary productization interview set is the eight questions in §9.14. Use these cards if you need extra one-breath drills after the architecture chapters. Depth: Chapter 9, Chapter 10, Appendix F, Appendix G.
...
<div class="nav-links">
  <a href="ch22-abbreviations-and-terminology">&larr; Previous</a>
