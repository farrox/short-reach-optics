...
Program-phase labels (EVT, DVT, PVT, MP) are owned in §11.4, Table 11.3. They are not a second lifecycle. The table below is a manufacturing-evidence lookup: which release call the gate evidence supports when the program uses those names.
...
**Table G.1.** NPI gates as a manufacturing evidence lookup. Pilot sits between PVT and MP. MP is sustained control, not fleet monitoring alone. Phase definitions: §11.4. Argument structure: Chapter 11.
...
Telemetry, lot traceability, RMA codes split by mechanism, and recurrence monitoring (§12.10). These catch what ATP never saw.
...
- Qualification re-entry depth when life or environmental mechanisms are affected (Chapter 11, Appendix F).
...
The following sections are the former manufacturing-validation chapter body, kept as reference depth. Start from Chapter 11 for the interview spine. Extended drills remain in Appendix G.20.1, Appendix M.12.
...
*Check.* Only when evidence ties the mechanism to a preventable production or test-control gap. Otherwise wear-out, interop, install, service, software, or residual latent risk (Appendix G.18, Chapter 12).


<div class="nav-links">
  <a href="ch18-reliability-qualification-reference">&larr; Previous</a>
  <a href="./">Table of Contents</a>
  <a href="ch20-ai-fabric-context">Next &rarr;</a>
</div>
